            ...
            <div class="mx-auto max-w-md">
                <div class="mb-6 text-center">
                    ...
                    <p class="text-gray-600">
                        Halo {{ props.user?.name }}, silahkan pilih jenis
                        transaksi
                    </p>
                </div>
                ...
                <div class="rounded-lg bg-white p-6 shadow-sm">
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <button
                            type="submit"
                            class="w-full rounded bg-green-600 py-2 font-medium text-white transition hover:bg-green-700"
                            :disabled="isLoading"
                        >
            ...
            <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
                <div class="mb-4 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        Transfer e-wallet berhasil diproses
                    </p>
                </div>
                ...
                <div id="print-area" class="mb-4 rounded-lg bg-gray-50 p-4">
                    <div class="space-y-2 text-sm">
                        <div>
                            <span class="font-medium">Jenis E-Wallet:</span>
                            {{ transactionResult.wallet_type }}
                        </div>
                        <div>
                            <span class="font-medium">No Tujuan:</span>
                            {{ transactionResult.wallet_number }}
                        </div>
                        <div>
